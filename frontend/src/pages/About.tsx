  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <Link
          to="/"
          className="text-xs text-primary-400 hover:text-primary-300 mb-3 inline-flex items-center gap-1.5 transition-colors font-semibold"
        >
      ...
      <div className="vault-panel p-4 mb-4">
        <h2 className="text-sm font-display font-bold text-dark-200 mb-3 flex items-center gap-2">
      ...
      <div className="vault-panel p-4 mb-4 border-2 border-primary-600/30">
        ...
        <div className="space-y-2 text-xs text-dark-300 leading-relaxed">
          ...
          <div className="bg-vault-dark-4 rounded-md p-3 mt-3 border border-dark-600">
            ...
            <ul className="space-y-1.5 text-xs text-dark-400 ml-5 list-disc">
          ...
          <p className="mt-3 text-xs text-dark-400 italic">
      ...
      <div className="vault-panel p-4 mb-4">
        ...
        <div className="space-y-3">
          <div className="bg-vault-dark-4 rounded-md p-3 border border-dark-600">
            <div className="flex items-start gap-2 mb-2">
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary-600/30 flex items-center justify-center text-xs font-bold text-primary-400">1</span>
              <div className="flex-1">
                <h3 className="text-xs font-semibold text-dark-200 mb-1">Create Your Vault</h3>
          ...
          <div className="bg-vault-dark-4 rounded-md p-3 border border-dark-600">
            <div className="flex items-start gap-2 mb-2">
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary-600/30 flex items-center justify-center text-xs font-bold text-primary-400">2</span>
              <div className="flex-1">
                <h3 className="text-xs font-semibold text-dark-200 mb-1">Propose Transactions</h3>
                <p className="text-xs text-dark-400 leading-relaxed">
          ...
          <div className="bg-vault-dark-4 rounded-md p-3 border border-dark-600">
            <div className="flex items-start gap-2 mb-2">
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary-600/30 flex items-center justify-center text-xs font-bold text-primary-400">3</span>
              <div className="flex-1">
                <h3 className="text-xs font-semibold text-dark-200 mb-1">Gather Approvals</h3>
                <p className="text-xs text-dark-400 leading-relaxed">
          ...
          <div className="bg-vault-dark-4 rounded-md p-3 border border-dark-600">
            <div className="flex items-start gap-2 mb-2">
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary-600/30 flex items-center justify-center text-xs font-bold text-primary-400">4</span>
              <div className="flex-1">
                <h3 className="text-xs font-semibold text-dark-200 mb-1">Execute</h3>
                <p className="text-xs text-dark-400 leading-relaxed">
      ...
      <div className="vault-panel p-4 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="bg-vault-dark-4 rounded-md p-3 border border-dark-600">
            <h3 className="text-xs font-semibold text-primary-400 mb-1.5 flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="vault-panel p-4 mb-4 border-2 border-yellow-600/30 bg-yellow-900/5">
        <h2 className="text-sm font-display font-bold text-yellow-300 mb-3 flex items-center gap-2">
        ...
        <div className="space-y-3">
          <div className="bg-yellow-900/20 rounded-md p-3 border border-yellow-700/30">
            <h3 className="text-xs font-bold text-yellow-300 mb-2 flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-yellow-900/30 rounded-md p-2.5 mt-2 border border-yellow-700/40">
              <p className="text-xs font-semibold text-yellow-200 mb-1.5 flex items-center gap-1.5">
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
                What You Should Do
              </p>
              <ul className="space-y-1 text-xs text-yellow-200/90 ml-5 list-disc">
      ...
      <div className="vault-panel p-4 mb-4">
        ...
        <div className="space-y-3 text-xs text-dark-300 leading-relaxed">
          <div>
            <h3 className="text-xs font-semibold text-dark-200 mb-1.5">Smart Contract Layer</h3>
            <p className="text-xs text-dark-400 mb-2">
              Quai Vault uses an upgradeable proxy pattern with three core components:
            </p>
            <ul className="space-y-1 text-xs text-dark-400 ml-4 list-disc">
          ...
          <div>
            <h3 className="text-xs font-semibold text-dark-200 mb-1.5">Frontend Layer</h3>
            <p className="text-xs text-dark-400 mb-2">
          ...
          <div>
            <h3 className="text-xs font-semibold text-dark-200 mb-1.5">Security Features</h3>
            <ul className="space-y-1 text-xs text-dark-400 ml-4 list-disc">
      ...
      <div className="vault-panel p-4 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="bg-vault-dark-4 rounded-md p-3 border border-dark-600">
            <h3 className="text-xs font-semibold text-primary-400 mb-1.5">Team Wallets</h3>
            <p className="text-xs text-dark-400 leading-relaxed">
          ...
          <div className="bg-vault-dark-4 rounded-md p-3 border border-dark-600">
            <h3 className="text-xs font-semibold text-primary-400 mb-1.5">High-Value Storage</h3>
            <p className="text-xs text-dark-400 leading-relaxed">
          ...
          <div className="bg-vault-dark-4 rounded-md p-3 border border-dark-600">
            <h3 className="text-xs font-semibold text-primary-400 mb-1.5">DAO Treasuries</h3>
            <p className="text-xs text-dark-400 leading-relaxed">
          ...
          <div className="bg-vault-dark-4 rounded-md p-3 border border-dark-600">
            <h3 className="text-xs font-semibold text-primary-400 mb-1.5">Escrow Services</h3>
            <p className="text-xs text-dark-400 leading-relaxed">
      ...
      <div className="vault-panel p-4 mb-4 border-2 border-primary-600/30">
        ...
        <div className="space-y-2 text-xs text-dark-300 leading-relaxed">
          ...
          <div className="mt-3 flex gap-2">
            <Link
              to="/create"
              className="vault-button text-xs px-3 py-1.5 inline-flex items-center gap-1.5"
            >
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Link
              to="/"
              className="vault-button-secondary text-xs px-3 py-1.5 inline-flex items-center gap-1.5"
            >
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
