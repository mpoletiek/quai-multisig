        ...
        <div>
          ...
          <div className="space-y-3">
            {disabledModules.map((module) => {
              const isSocialRecovery = module.address === CONTRACT_ADDRESSES.SOCIAL_RECOVERY_MODULE;
              return (
                <div key={module.address} className="space-y-2">
                  ...
                  {isSocialRecovery && (
                    <div className="ml-14 bg-gradient-to-r from-purple-900/90 via-purple-800/90 to-purple-900/90 border-l-4 border-purple-600 rounded-md p-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-xs text-purple-200/90">
                            <strong>Note:</strong> Social Recovery allows wallet recovery through guardian consensus. This module is currently not fully implemented in this frontend. Configuration and recovery features will be available in a future update.
                          </p>
                        </div>
                      </div>
                    </div>
